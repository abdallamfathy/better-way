...
//     <div className="flex flex-col justify-center">
//     <a href="#">
//         <img className="p-8 rounded-t-lg object-cover h-64 w-96" src={food} alt="product image" />
//     </a>
  
//     </div>
//     <div className="px-5 pb-5">
//         <a href="#">
//             <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white ">خصم 31% من ملوك الكبدة والسجق في مصر في فروع عز المنوفي! فقط 59 جنيه بدلا من 85 جنيه</h5>
//         </a>
...
//             <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">٥</span>
//         </div>
//         <div className="flex items-center justify-between">
//             <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">اضف الي العربة</a>
//             <span className="text-3xl font-bold text-gray-900 dark:text-white">٤٥٦ جنيه</span>
//         </div>
//     </div>
// </div>
// </SwiperSlide>
